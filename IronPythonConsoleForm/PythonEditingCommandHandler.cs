...
namespace PythonConsoleControl
{
  ...
  class PythonEditingCommandHandler
  {
    ...
    public static void CanCutOrCopy(object target, CanExecuteRoutedEventArgs args)
    {
    ...
    public static TextArea GetTextArea(object target)
    {
      return target as TextArea;
    }

    public static void OnCopy(object target, ExecutedRoutedEventArgs args)
    {
      TextArea textArea = GetTextArea(target);
      if (textArea != null && textArea.Document != null)
      {
    ...
    public static void OnCut(object target, ExecutedRoutedEventArgs args)
    {
      TextArea textArea = GetTextArea(target);
      if (textArea != null && textArea.Document != null)
      {
    ...
    public static void CopySelectedText(TextArea textArea)
    {
    ...
    public static void CopyWholeLine(TextArea textArea, DocumentLine line)
    {
    ...
    public static ExecutedRoutedEventHandler OnDelete(RoutedUICommand selectingCommand)
    {
      return (target, args) =>
      {
        TextArea textArea = GetTextArea(target);
    ...
    public static void CanDelete(object target, CanExecuteRoutedEventArgs args)
    {
